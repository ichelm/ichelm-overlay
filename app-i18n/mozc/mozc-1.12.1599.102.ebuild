...
inherit elisp-common eutils multilib multiprocessing python-any-r1 subversion toolchain-funcs
...
ESVN_REPO_URI="http://gyp.googlecode.com/svn/trunk@1732"
ESVN_PROJECT="gyp"
...
DEPEND="${RDEPEND}
	${PYTHON_DEPS}
	system-protobuf? ( >=dev-libs/protobuf-2.5.0 )
	virtual/pkgconfig"
...
src_unpack() {
	...
	if ! use system-protobuf; then
		...
		mv protobuf-${PROTOBUF_VER} protobuf || die
	fi

	subversion_fetch "" "third_party/gyp"
